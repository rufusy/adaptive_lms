                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="summernote" name="description" rows="30">
                                    <?= $content->description; ?>
                                </textarea>
                            </div>
...
$('.file-drop-zone-title').html('<b class=text-primary>No Files Attached / Uploaded</b>');
$('.file-caption-main').html('');
$('button.fileinput-remove').remove();
$('.file-footer-buttons button').prop('disabled',false);
JS;
